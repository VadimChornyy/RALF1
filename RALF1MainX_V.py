    ...
    while hhh_<aTmStop and not key == 13: 
        ...
        if ZZ==0:                  
            ...
            for iGr in range(Ngroup):                
                ...
                anI=len(ZDat)
                [arr_RezM[iGr],NQRandm,QRandm_]=finalAnalysRALF1(anI,ZDat,NNew,NQRandm,QRandm_)    
                # if anI>1:          
                #     for hhhx in range(anI):
                #         D=np.std(ZDat)                     
                #         aa=RandomQQ(Nf,NQRandm)                        
